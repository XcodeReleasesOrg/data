...
extension Xcode {
    ...
    public static let allVersions: Array<Xcode> = {
        var everything = xcodes27 + xcodes26 + xcodes16 + xcodes15 + xcodes14 + xcodes13 + xcodes12 + xcodes11 + xcodes10 + xcodes9 + xcodes8 + xcodes7 + xcodes6 + xcodes5 + xcodes4 + xcodes3 + xcodes2 + xcodes1
